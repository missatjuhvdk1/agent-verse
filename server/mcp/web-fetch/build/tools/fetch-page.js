...
import { FetchPageSchema } from '../schemas/tool-schemas.js';
 ...
 */
export async function fetchPageTool(args) {
    ...
    try {
        ...
        throw new FetchError(`Failed to fetch page: ${message}`, url, error);
    }
}
